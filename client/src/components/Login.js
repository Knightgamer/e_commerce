      ...
      <div className="p-6 max-w-sm w-full bg-white shadow-md rounded-lg">
        ...
        <form>
          ...
          <button
            type="button"
            onClick={handleLogin}
            className="mt-6 w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-500 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
          >
            Login
          </button>
        </form>
